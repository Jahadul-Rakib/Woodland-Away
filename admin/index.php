...
<?php
    ...
    $totalAnimal = count($allAnimal);

    $usrObj = new User();
    $allUser = $usrObj->alluser();
    $totalUser = count($allUser);

    use App\Booking\Booking;
    $bookingObj = new Booking();
    $allBooking = $bookingObj->allBooking();
    $totalbooking = count($allBooking);

    use App\Message\Message;
    $messageObj=new Message();
    $messages = $messageObj->allcontact();
            ...
            <div class="row">
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="info-box dark-bg">
						...
						<div class="count"><?php echo $totalAnimal; ?></div>
						<div class="title">Total Reserved</div>
					</div><!--/.info-box-->			
				</div><!--/.col-->
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="info-box green-bg">
						...
						<div class="count"><?php echo $totalMessage; ?></div>
