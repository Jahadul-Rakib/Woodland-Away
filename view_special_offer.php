  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Speical offer</li>
      </ol>
      <div class="row">
...
if(isset($_GET['day'])){
    ...
    echo "<b>Today's Date- </b>".date('m/d/Y');
  ...
  <table  class="table table-bordered">
    <tr>
      <td align="center"><input type="button" name="" value="pervious" style="width: 70px" onclick="goLastMonth(<?php echo $month.",". $year ?>)"></td>
      <td colspan="5" align="center"><?php echo $MonthName.", ".$year ?></td>
      <td align="center"><input type="button" name="" value="Next" style="width: 70px" onclick="goNextMonth(<?php echo $month.",". $year ?>)"></td>
